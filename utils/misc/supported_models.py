...
import utils.misc.text_encoders.aura_t5
import utils.misc.text_encoders.hydit
import utils.misc.text_encoders.flux
...
class SD20(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(utils.misc.text_encoders.sd2_clip.SD2Tokenizer, utils.misc.text_encoders.sd2_clip.SD2ClipModel)
...
class SD3(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        ...
        if "{}clip_g.transformer.text_model.final_layer_norm.weight".format(pref) in state_dict:
            clip_g = True
        t5_detect = utils.misc.text_encoders.sd3_clip.t5_xxl_detect(state_dict, "{}t5xxl.transformer.".format(pref))
        if "dtype_t5" in t5_detect:
            t5 = True

        return supported_models_base.ClipTarget(utils.misc.text_encoders.sd3_clip.SD3Tokenizer, utils.misc.text_encoders.sd3_clip.sd3_clip(clip_l=clip_l, clip_g=clip_g, t5=t5, **t5_detect))
...
class StableAudio(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(utils.misc.text_encoders.sa_t5.SAT5Tokenizer, utils.misc.text_encoders.sa_t5.SAT5Model)
...
class AuraFlow(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(utils.misc.text_encoders.aura_t5.AuraT5Tokenizer, utils.misc.text_encoders.aura_t5.AuraT5Model)
...
class HunyuanDiT(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(utils.misc.text_encoders.hydit.HyditTokenizer, utils.misc.text_encoders.hydit.HyditModel)
...
class Flux(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        pref = self.text_encoder_key_prefix[0]
        t5_detect = utils.misc.text_encoders.sd3_clip.t5_xxl_detect(state_dict, "{}t5xxl.transformer.".format(pref))
        return supported_models_base.ClipTarget(utils.misc.text_encoders.flux.FluxTokenizer, utils.misc.text_encoders.flux.flux_clip(**t5_detect))
...
class GenmoMochi(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        pref = self.text_encoder_key_prefix[0]
        t5_detect = utils.misc.text_encoders.sd3_clip.t5_xxl_detect(state_dict, "{}t5xxl.transformer.".format(pref))
        return supported_models_base.ClipTarget(utils.misc.text_encoders.genmo.MochiT5Tokenizer, utils.misc.text_encoders.genmo.mochi_te(**t5_detect))
...
class LTXV(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        pref = self.text_encoder_key_prefix[0]
        t5_detect = utils.misc.text_encoders.sd3_clip.t5_xxl_detect(state_dict, "{}t5xxl.transformer.".format(pref))
        return supported_models_base.ClipTarget(utils.misc.text_encoders.lt.LTXVT5Tokenizer, utils.misc.text_encoders.lt.ltxv_te(**t5_detect))
