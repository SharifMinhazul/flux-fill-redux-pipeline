...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps=None, context=None, y=None, control=None, transformer_options={}, **kwargs):
        return utils.misc.patcher_extension.WrapperExecutor.new_class_executor(
            self._forward,
            self,
            utils.misc.patcher_extension.get_all_wrappers(utils.misc.patcher_extension.WrappersMP.DIFFUSION_MODEL, transformer_options)
