...
class SDClipModel(torch.nn.Module, ClipTokenWeightEncoder):
    ...
    def __init__(self, device="cpu", max_length=77,
                 freeze=True, layer="last", layer_idx=None, textmodel_json_config=None, dtype=None, model_class=utils.misc.clip_model.CLIPTextModel,
        ...
        if operations is None:
            ...
            if scaled_fp8 is not None:
                operations = utils.misc.ops.scaled_fp8_ops(fp8_matrix_mult=False, override_dtype=scaled_fp8)
            else:
                operations = utils.misc.ops.manual_cast
