...
from utils.misc.ldm.modules.diffusionmodules.mmdit import Mlp, TimestepEmbedder, PatchEmbed, RMSNorm
from utils.misc.ldm.modules.diffusionmodules.util import timestep_embedding
...
class HunYuanDiT(nn.Module):
    ...
    def forward(self,
        ...
        padding = utils.misc.ops.cast_to_input(self.text_embedding_padding, text_states)
