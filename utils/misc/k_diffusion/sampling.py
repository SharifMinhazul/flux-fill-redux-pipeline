...
def sample_euler_ancestral(model, x, sigmas, extra_args=None, callback=None, disable=None, eta=1., s_noise=1., noise_sampler=None):
    if isinstance(model.inner_model.inner_model.model_sampling, utils.misc.model_sampling.CONST):
...
def sample_euler_cfg_pp(model, x, sigmas, extra_args=None, callback=None, disable=None):
    ...
    extra_args["model_options"] = utils.misc.model_patcher.set_model_options_post_cfg_function(model_options, post_cfg_function, disable_cfg1_optimization=True)
